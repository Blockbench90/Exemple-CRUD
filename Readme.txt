...
Все что нужно, для подключения к базе данных, это предложеный вам в конце URL, который нужно вставить в файл config, вставив туда свое имя и пароль для подключения
